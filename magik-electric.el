...
(defvar magik-electric-templates-methods
  '(("define_shared_constant" -3 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_shared_constant(:, ,\n\t## \n\t## \n\t## \n\t)\n" dollar))
    ("define_shared_variable" -3 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_shared_variable(:, ,\n\t## \n\t## \n\t## \n\t)\n" dollar))
    ("define_slot_access" -3 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_slot_access(:, :\n\t## \n\t## \n\t## \n\t)\n" dollar))
    ("define_pseudo_slot" e 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_pseudo_slot(:\n\t## \n\t## \n\t## \n\t)\n" dollar))
    ("define_print_attributes" -1 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_print_attributes()\n" dollar))
    ("define_show_attributes" -1 1 (prev_pragma magik-electric-default-pragma)
     (prev_class_name "define_show_attributes()\n" dollar))
    ("def_property" e 1 (prev_pragma magik-electric-default-pragma)
...
(defvar magik-electric-templates
  (append
   '(("iter" e 1 (prev_pragma magik-electric-default-pragma) ("_iter _method " prev_class_name) "\t## " "\t## "
      - "_endmethod" dollar)
     ("private" e 1 (prev_pragma "_pragma(classify_level=restricted, topic={}, usage={})") ("_private _method " prev_class_name) "\t## " "\t## "
      - "_endmethod" dollar)
     ("abstract" e 1 (prev_pragma magik-electric-default-pragma) ("_abstract _method " prev_class_name) "\t## " "\t## "
      - "_endmethod" dollar)
     ("method" e 1 (prev_pragma magik-electric-default-pragma) ("_method " prev_class_name) "\t## " "\t## " - "_endmethod"
      dollar)
     ("pragma" 17 0 (prev_pragma magik-electric-default-pragma))
     ("def_slotted_exemplar" e 2 (prev_pragma magik-electric-default-pragma)
      ("def_slotted_exemplar(" filename_as_symbol ",\n\t## \n\t## \n\t## \n\t{\n\t},\n\t{})\n" dollar))
     ("def_mixin" -1 1 (prev_pragma magik-electric-default-pragma)
     ...
     ("define_binary_operator_case" -5 1 (prev_pragma magik-electric-default-pragma)
